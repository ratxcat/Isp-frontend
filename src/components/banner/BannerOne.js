                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5">
                            <div className="banner-wrapper-one">
                                <span className="pre-title" data-aos="fade-up" data-aos-duration="1000">Meet Cherry Enterprise</span>
                                <h1 className="title" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                                    Internet solutions <br /> for a <span>growing </span>
                                    businesses
                                </h1>
                                <p data-aos="fade-up" data-aos-delay="500">
                                    Empowering enterprises with innovative technology and Internet to stay
